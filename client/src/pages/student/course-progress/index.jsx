...
function StudentViewCourseProgressPage() {
  ...
  <div className="flex flex-1 overflow-hidden">
    <div className={`flex-1 ${isSideBarOpen ? "mr-[0px]" : ""} transition-all duration-300`}>
      <VideoPlayer
        width="100%"
        height="500px"
    ...
    {isSideBarOpen && (
      <div className="w-[400px] bg-[#1c1d1f] border-l border-gray-700 transition-all duration-300 flex-shrink-0">
        <Tabs defaultValue="content" className="h-full flex flex-col">
          <TabsList className="grid bg-[#1c1d1f] w-full grid-cols-2 p-0 h-14">
            <TabsTrigger value="content" className=" text-yellow-400 rounded-none h-full">
              Course Content
            </TabsTrigger>
            <TabsTrigger value="overview" className=" text-yellow-400 rounded-none h-full">
              Overview
            </TabsTrigger>
          </TabsList>
  ...
  <DialogContent showOverlay={false} className="sm:max-w-md rounded-lg bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 shadow-lg">
