...
function StudentViewCourseDetailsPage() {
  ...
  async function fetchStudentViewCoursesDetails() {
    ...
    const response = await fetchStudentCoursesDetails(
      currentCourseDetailsId,
      auth?.user?._id
    );
          ...
          <Card className="sticky top-4">
            <CardContent className="p-6">
              ...
              <Button
                onClick={() =>
                  checkoutHandler(
                    DiscountedPrice || studentViewCourseDetails?.pricing
                  )
                }
                className="w-full"
              >
      ...
      <Card className="mt-8 mb-8 bg-[#f8f9fa] dark:bg-[#1a1a1a] shadow-lg rounded-xl transition-all duration-300">
        ...
        <CardContent>
          <p className="mb-3 text-gray-800 dark:text-gray-200 text-base leading-relaxed">
            Show off your skills and earn a discount by completing a short
            challenge exam. It’s your knowledge that counts — not just your
            wallet.
          </p>
          ...
          <div className="flex justify-center">
            <Button
              onClick={() =>
                navigate(
                  `/student/student-courses/start-exam/${studentViewCourseDetails?._id}`
                )
              }
